...
public:
    ...
    virtual bool SelectItem(int nIndex, bool bTakeFocus = false) = 0;
	virtual bool SelectRange(int nIndex, bool bTakeFocus = false) = 0;
    virtual void DoEvent(TEventUI& event) = 0;
	virtual void MoveSelectedItemToHotItem() = 0;//移动项
	virtual void SetHotItemIndex(int nIndex) = 0;
	virtual void SetMouseState(bool bDown) = 0;
	virtual bool NeedCurSelectNotify()=0;
};
...
public:
    ...
    virtual bool ExpandItem(int nIndex, bool bExpand = true) = 0;
...
public:
	...
	virtual bool GetLastSelected() const = 0;
	virtual bool SetLastSelected(bool bLastSelected) = 0;
};
...
class DirectUI_API CListUI : public CVerticalLayoutUI, public IListUI
{
public:
    CListUI();
	...
	CListBodyUI* GetBodyList(){ return m_pList;	}

    bool GetScrollSelect();
    void SetScrollSelect(bool bScrollSelect);
    int GetCurSel() const;
    bool SelectItem(int nIndex, bool bTakeFocus = false);
    bool SelectItem(CControlUI* pControlUI, bool bTakeFocus = false);
	...
	bool GetSelectHorizontal()const;
	void SetSelectHorizontal(bool bSel);
	...
	void SetListItemDrag(bool bDrag);
	bool GetListItemDrag() const;
	void MoveSelectedItemToHotItem();
	void SetHotItemIndex(int nIndex);
	int GetHotItemIndex() const;
	void SetMouseState(bool bDown);
	virtual bool NeedCurSelectNotify(){return false;}
protected:
    bool m_bScrollSelect;
	bool m_bCombinationList;
    int m_iCurSel;
    int m_iExpandedItem;
	...
	bool m_bKeySelectHorizontal;
	bool m_bMultiSelect;
	bool m_bListItemDrag;
	int m_iHotItemIndex;
	bool m_bMouseState; //false : mouse up , true : mouse down
	int m_nArrowKeysVIndex;
	int m_nArrowKeysHIndex;
...
class DirectUI_API CListBodyUI : public CVerticalLayoutUI
{
public:
    ...
    BOOL SortItems(PULVCompareFunc pfnCompare, UINT_PTR dwData);
protected:
	void SetListPos(RECT rc);
	void SetListViewPos(RECT rc);
...
class DirectUI_API CListHeaderUI : public CHorizontalLayoutUI
{
public:
    CListHeaderUI();
...
class DirectUI_API CListHeaderItemUI : public CControlUI
{
public:
    CListHeaderItemUI();
...
class DirectUI_API CListElementUI : public CControlUI, public IListItemUI
{
public:
    CListElementUI();
...
class DirectUI_API CListLabelElementUI : public CListElementUI
{
public:
    CListLabelElementUI();
	...
	bool SetLastSelected(bool bLastSelected);
};
...
class DirectUI_API CListTextElementUI : public CListLabelElementUI
{
public:
    CListTextElementUI();
    ~CListTextElementUI();
    ...
    void SetText(int nIndex, LPCTSTR pstrText);
...
class DirectUI_API CListContainerElementUI : public CContainerUI, public IListItemUI
{
public:
	...
	bool GetLastSelected() const;
	bool SetLastSelected(bool bLastSel);
	...
	void SetItemDragState(bool bState);
	bool GetItemDragState() const;
