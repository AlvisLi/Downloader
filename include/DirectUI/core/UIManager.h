...
public:
    ...
    static CUIString GetInstancePath();
    static CUIString GetCurrentPath();
    static HINSTANCE GetResourceDll();
    static const CUIString& GetResourcePath();
    static const CUIString& GetResourceZip();
    ...
    const TImageInfo* AddImage(LPCTSTR bitmap, HBITMAP hBitmap, int iWidth, int iHeight, TImageInfo* pImage);

    bool RemoveImage(LPCTSTR bitmap);
	void ReMoveAllImagesToAother(CPaintManagerUI* pOther);
    ...
    bool SetTimer(LPCTSTR strControl, UINT nTimerID, UINT uElapse);
    bool KillTimer(LPCTSTR strControl, UINT nTimerID);
    void KillTimer(LPCTSTR strControl);
    ...
    bool SetPostPaintIndex(CControlUI* pControl, int nIndex);
    ...
    CControlUI* FindSubControlByClass(CControlUI* pParent, LPCTSTR pstrClass, int nIndex = 0);
	...
	static void Term();
	static bool AddGlobalTranslateAccelerator(ITranslateAccelerator *pTrans);
	static bool RemoveGlobalTranslateAccelerator(ITranslateAccelerator *pTrans);
...
private:
    ...
    static CUIString m_pStrResourcePath;
    static CUIString m_pStrResourceZip;
	...
	static CStdPtrArray m_aGlobalTransAccel;
public:
	static CUIString m_pStrDefaultFontName;
