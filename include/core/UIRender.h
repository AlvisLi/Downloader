...
public:
    ...
    static TImageInfo* LoadImage(STRINGorID bitmap, LPBYTE pData, DWORD dwSize, DWORD mask = 0);
    static TImageInfo* LoadImage(STRINGorID bitmap, HBITMAP hBitmap, int nWidth, int nHeight, bool bAlphaChannel=false);
    ...
    static void DrawHtmlText(HDC hDC, CPaintManagerUI* pManager, RECT& rc, LPCTSTR pstrText, 
        DWORD dwTextColor, RECT* pLinks, CUIString* sLinks, int& nLinkRects, UINT uStyle);
